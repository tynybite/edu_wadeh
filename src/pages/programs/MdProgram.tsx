        ...
        <div className="container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 opacity-80 max-w-2xl mx-auto">
              Advance your expertise with a 2-year postgraduate program focused
              on research, advanced therapeutics, and clinical leadership in
              Electro-Homeopathy.
            </p>
          ...
          <CardContent>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                <div>
                  <strong>Educational Qualification:</strong> B.E.M.S. or
                  equivalent degree in Electro-Homeopathy or allied health
                  sciences
                </div>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                <div>
                  <strong>Minimum Marks:</strong> Minimum 55% aggregate marks in
              ...
              <li className="flex items-start gap-3">
                <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                <div>
                  <strong>Experience:</strong> Clinical experience preferred but
                  not mandatory
                </div>
              </li>
              <li className="flex items-start gap-3">
                <CheckCircle2 className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                <div>
                  <strong>Research Interest:</strong> Statement of purpose
                  outlining research interests and career goals
                </div>
              </li>
            </ul>
          </CardContent>
          ...
          {[
            {
              ...
              description:
                "Lead cutting-edge research projects and contribute to medical literature",
            },
            {
              icon: GraduationCap,
              title: "Academic Positions",
              description:
                "Become a faculty member at medical colleges and training institutions",
            },
            {
              icon: Briefcase,
              title: "Specialist Practitioner",
              description:
                "Establish yourself as an advanced specialist in Electro-Homeopathy",
            },
            {
              icon: FlaskConical,
              title: "Healthcare Innovation",
              description:
                "Develop new treatment protocols and advance the field",
            },
          ].map((outcome, index) => (
            <Card key={index}>
              <CardHeader>
          ...
          {[
            {
              ...
              description:
                "Equipped with latest instruments for clinical research and analysis",
            },
            {
              title: "Digital Library",
              description:
                "Access to international journals, databases, and research publications",
            },
            {
              title: "Clinical Research Center",
              description:
                "Dedicated facility for conducting clinical trials and case studies",
            },
            {
              title: "Expert Mentorship",
              description:
                "Guidance from experienced researchers and clinicians",
            },
            {
              title: "Collaboration Network",
              description:
                "Partnerships with research institutions and hospitals",
            },
            {
      ...
      <Section className="bg-primary text-primary-foreground">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg opacity-90 mb-8">
            Join our research-focused postgraduate program and become a leader
            in Electro-Homeopathy. Admissions for 2026 are now open!
          </p>
          <div className="flex flex-wrap gap-4 justify-center">
            <Button size="lg" variant="secondary" asChild>
